...
// // ── Survey Details (Survey Officer भरतो — geo location, photos, comments) ──
...
//       lng: { type: Number },
//     },
//     surveyPhotos: [{ type: String }], // Cloudinary URLs
...
// // ── Concern Officer (Ward-wise A.M.C.) Action ──
// const concernOfficerActionSchema = new mongoose.Schema(
//   {
...
//     decision: {
//       type: String,
//       enum: ["Approved", "Sent Back", "Rejected", ""],
//       default: "",
//     },
...
// // ── Smart Card / Certificate (QR based) ──
// const certificateSchema = new mongoose.Schema(
//   {
//     certificateNo: { type: String, default: "" },
//     qrCodeData: { type: String, default: "" },   // verification URL encoded in QR
//     qrCodeUrl: { type: String, default: "" },     // stored QR image (Cloudinary/base64)
//     issueDate: { type: Date },
//     validTill: { type: Date },
//   },
//   { _id: false }
...
//     identityType: { type: String, default: "" },      // Aadhar / Voter ID etc.
//     identityNumber: { type: String, default: "" },

//     businessName: { type: String, default: "" },
//     businessType: { type: String, default: "" },       // e.g. Fruit vendor, Food stall

//     // ── Ward & Vending Location ──
//     ward: {
//       type: String,
//       enum: [...WARDS, ""],
//       default: "",
...
//     documents: [
//       {
//         docType: { type: String, default: "" }, // e.g. Aadhar, Photo, Shop Proof
...
//     // ── Concern Officer (Ward AMC) stage ──
//     concernOfficerAction: concernOfficerActionSchema,
