...
//     if (application.status !== "A.M.C. Approved") {
//       return res.status(400).json({ success: false, message: "ID Card फक्त A.M.C. Approved applications साठीच generate करता येतो ❌" });
//     }
...
//       return res.status(400).json({ success: false, message: "applicationNos array आवश्यक आहे ❌" });
//     }
